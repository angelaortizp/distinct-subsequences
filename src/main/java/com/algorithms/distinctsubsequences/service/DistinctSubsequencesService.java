package com.algorithms.distinctsubsequences.service;
...
public class DistinctSubsequencesService {
	...
	public int calculateDistinctSubsequences(String source, String target) {
		...
		// Matriz 2D que guardará las subsecuencias distintas encontradas teniendo en
		// cuenta el caso vacío
		...
		return subsequencesCount[sourceInitial][targetFinal];
	}
